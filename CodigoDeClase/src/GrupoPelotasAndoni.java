 ...
 */
public class GrupoPelotasAndoni {
	 ...
	 */
	public GrupoPelotasAndoni( int numMax ) {
	...
	public static void main(String[] args) {
		GrupoPelotasAndoni g = new GrupoPelotasAndoni(2);
		System.out.println( g.anyadePelota( new Pelota(0,0,1,Color.BLACK) ) );
		System.out.println( g.anyadePelota( new Pelota(0,0,1,Color.BLACK) ) );
		System.out.println( g.anyadePelota( new Pelota(0,0,1,Color.BLACK) ) );
